...
var process_mode setget set_process_mode, get_process_mode
var follow_mode: int = FollowMode.SINGLE_TARGET setget set_follow_mode, get_follow_mode
var drag_type : int = DragType.SMOOTH_DAMP setget set_drag_type, get_drag_type
var smooth_drag: bool = true setget set_smooth_drag, get_smooth_drag
var smooth_drag_speed: Vector2 = Vector2(5, 5) setget set_smooth_drag_speed, get_smooth_drag_speed
var prediction_time: Vector2 = Vector2(9, 9) setget set_prediction_time, get_prediction_time
var offset: Vector2 = Vector2.ZERO setget set_offset, get_offset
var smooth_offset: bool = true setget set_smooth_offset, get_smooth_offset
var smooth_offset_speed: float = 5.0 setget set_smooth_offset_speed, get_smooth_offset_speed
var allow_rotation: bool = false setget set_allow_rotation, get_allow_rotation
var smooth_rotation: bool = true setget set_smooth_rotation, get_smooth_rotation
var smooth_rotation_speed: float = 5.0 setget set_smooth_rotation_speed, get_smooth_rotation_speed
var zoom: float = 1.0 setget setter_for_zoom, get_zoom
var smooth_zoom: bool = true setget set_smooth_zoom, get_smooth_zoom
var smooth_zoom_speed: float = 5.0 setget set_smooth_zoom_speed, get_smooth_zoom_speed
var auto_zoom: bool = true setget set_auto_zoom, get_auto_zoom
var min_zoom: float = 0.0 setget set_min_zoom, get_min_zoom
var max_zoom: float = 1.0 setget set_max_zoom, get_max_zoom
var zoom_margin: float = 5.0 setget set_zoom_margin, get_zoom_margin
var smooth_limit: bool = true setget set_smooth_limit, get_smooth_limit
var left_limit: int = -10000000 setget set_left_limit, get_left_limit
var right_limit: int = 10000000 setget set_right_limit, get_right_limit
var top_limit: int = -10000000 setget set_top_limit, get_top_limit
var bottom_limit: int = 10000000 setget set_bottom_limit, get_bottom_limit
var use_h_margins: bool = false setget set_use_h_margins, get_use_h_margins
var use_v_margins: bool = false setget set_use_v_margins, get_use_v_margins
var left_margin: float = 0.3 setget set_left_margin, get_left_margin
var right_margin: float = 0.3 setget set_right_margin, get_right_margin
var top_margin: float = 0.3 setget set_top_margin, get_top_margin
